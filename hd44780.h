...
//                                                                                                                                                                           #
#include "msp430fr6989.h"                                   // Controller specific header file                                                                                #
//                                                                                                                                                                           #
// ###########################################################################################################################################################################
...
#define HD44780_ENABLE_MCU_OUT_PIN          BIT6           // Define MCU output pin that is connected to ENABLE of HD44780                                                   #
...
#define HD44780_RS_MCU_OUT_PIN              BIT4           // Define MCU output pin that is connected to RS of HD44780                                                       #
...
//                                                                                                                                                                           #
#define HD44780_D0_MCU_OUT_PORT            P3OUT           // Define MCU output port that is connected to DB0 of HD44780                                                     #
#define HD44780_D0_MCU_OUT_PIN             BIT3            // Define MCU output pin that is connected to DB0 of HD44780                                                      #
//#define HD44780_D0_INVERTED                              // Enable if signal for D0 is inverted by external hardware                                                       #
//                                                                                                                                                                           #
#define HD44780_D1_MCU_OUT_PORT            P3OUT           // Define MCU output port that is connected to DB1 of HD44780                                                     #
#define HD44780_D1_MCU_OUT_PIN             BIT6            // Define MCU output pin that is connected to DB1 of HD44780                                                      #
//#define HD44780_D1_INVERTED                              // Enable if signal for D1 is inverted by external hardware                                                       #
//                                                                                                                                                                           #
#define HD44780_D2_MCU_OUT_PORT            P3OUT           // Define MCU output port that is connected to DB2 of HD44780                                                     #
#define HD44780_D2_MCU_OUT_PIN             BIT7            // Define MCU output pin that is connected to DB2 of HD44780                                                      #
//#define HD44780_D2_INVERTED                              // Enable if signal for D2 is inverted by external hardware                                                       #
//                                                                                                                                                                           #
#define HD44780_D3_MCU_OUT_PORT            P2OUT           // Define MCU output port that is connected to DB3 of HD44780                                                     #
#define HD44780_D3_MCU_OUT_PIN             BIT2            // Define MCU output pin that is connected to DB3 of HD44780                                                      #
...
#define HD44780_D4_MCU_OUT_PIN             BIT3            // Define MCU output pin that is connected to DB4 of HD44780                                                      #
//#define HD44780_D4_INVERTED                              // Enable if signal for D4 is inverted by external hardware                                                       #
//                                                                                                                                                                           #
#define HD44780_D5_MCU_OUT_PORT            P3OUT           // Define MCU output port that is connected to DB5 of HD44780                                                     #
#define HD44780_D5_MCU_OUT_PIN             BIT0            // Define MCU output pin that is connected to DB5 of HD44780                                                      #
...
#define HD44780_D6_MCU_OUT_PIN             BIT1            // Define MCU output pin that is connected to DB6 of HD44780                                                      #
